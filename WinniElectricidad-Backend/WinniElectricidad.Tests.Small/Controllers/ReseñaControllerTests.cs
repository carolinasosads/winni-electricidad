...
public class ReseñaControllerTests
{
    ...
    public void Setup()
    {
        ...
        _controller = new ReseñaController(_mockAgregarReseña.Object, _mockServicioImagenes.Object);
    ...
    public async Task Reseñar_ConDatosValidos_SinImagen_DevuelveOkConReseñaCreada()
    {
        ...
        _mockServicioImagenes.Verify(s => s.GuardarAsync(It.IsAny<IFormFile>()), Times.Never);
    }
