...
export default function PaginaPrincipal() {
        ...
        return arr
            .map((s) => {
                ...
                const imagenPrincipal =
                    Array.isArray(s.imagenes) && s.imagenes.find((i) => i.esPrincipal)?.url;
    ...
    const handleEnviarConsulta = async (e) => {
        ...
        if (!nombre || !email || !telefonoSoloDigitos || !mensaje) {
            ...
            >
                ...
                <Box sx={{ backgroundColor: "#f7f8fb", py: { xs: 5, md: 7 } }}>
                    <Container maxWidth="lg">
                        ...
                        <Typography variant="h5" textAlign="center" sx={{ fontWeight: 800, mb: 4 }}>
                        ...
                        <Box sx={{ mt: 7 }}>
                            ...
                            <Typography variant="h5" textAlign="center" sx={{ fontWeight: 800, mb: 3 }}>
                ...
                <Box sx={{ py: 6, backgroundColor: "white" }}>
                    <Container maxWidth="md">
                        <Typography variant="h4" textAlign="center" gutterBottom sx={{ fontWeight: 900 }}>
                            Consultas generales
                        </Typography>

                        <Typography textAlign="center" sx={{ color: "text.secondary", mb: 3 }}>
                            Si querés contactarte por algo que no sea una reserva de presupuesto, escribinos acá.
                        </Typography>
