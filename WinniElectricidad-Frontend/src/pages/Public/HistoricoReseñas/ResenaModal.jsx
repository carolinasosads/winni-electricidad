    ...
    <Dialog open onClose={onClose} maxWidth="md" fullWidth>
      <DialogContent sx={{ p: 0 }}>
        ...
        <Stack spacing={2} sx={{ p: 4 }} textAlign="center">
          <Rating value={resena.calificacion} readOnly size="large" sx={{ color: "#F5A623" }} />

          <Typography sx={{ fontStyle: "italic", lineHeight: 1.7 }}>
            “{resena.descripcion}”
          </Typography>
          ...
          <Chip label={resena.servicio?.titulo ?? "Servicio"} size="small" sx={{ alignSelf: "center" }} />
