...
import {  Box,  Typography,  Drawer,  IconButton,  useMediaQuery,  Alert,  Card,  CardActionArea,  CardContent,
...
export default function PanelReservasCliente() {
    ...
    const [modalFeedback, setModalFeedback] = useState(null); // { severity, text }
    ...
    const detectarCambiosYNotificar = (prevMap, nextArr) => {
    ...
    async function recargarTodo() {
        ...
        const activas = arr.filter(
            (r) => new Date(r.fechaReserva) >= ahora && r.estado !== "Cancelada"
        );
